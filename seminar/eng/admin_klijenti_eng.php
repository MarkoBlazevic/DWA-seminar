        ...
        <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="index.php">Marina Punat</a>
            ...
            <ul class="nav navbar-nav">
			  <li><a href="../admin_klijenti.php">HRV</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10">
			...
			?>
			<form name="form1" method="POST" action="admin_klijenti_eng.php">
			...
			<tbody>
				...
				?>
					...
					<input name="delete" type="submit" class="btn btn-default" id="delete" value="Delete">
