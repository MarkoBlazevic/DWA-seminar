  ...
  <body>
        ...
        <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="index.php">Marina Punat</a>
            ...
            <ul class="nav navbar-nav">
				<li><a href="../rezervacija.php">HRV</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
			<h3>Search berth</h3><br/>
			<form name="unos" method="GET" action="odabir_veza_eng.php">
				<div class="input-group">				
					<label for="datumPocetak">Day of starting reservation:</label>
				...
				<div class="input-group">
					<label for="datumKraj">Day of ending reservation:</label>
					<input value id="datumKraj" type="text" name="datumKraj" class="form-control" readonly />					
				</div>
				
				<br/><br/>
				
				<label for="tipVeza">Pick size of berth:</label>
				<select name="vez">
					<option value="mali">Small berth</option>
					<option value="veliki">Big berth</option>
					<option value="vanjski">Outer berth</option>
				</select><br><br>
