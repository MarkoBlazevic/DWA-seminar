  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
		<h3>Yacht servis</h3>
          <p>The Shipyard Punat was founded in 1922 by Nikola Zoric who started, as the owner, the business of shipbuilding with 11 employees on an area of 1654m2. </p>
		  <p>On only two slipways, mainly wooden vessels were built up to 350t. Boats made of wood: rafts, boats, barges, fishing boats, patrol boats, sailing boats, cargo boats and yachts. At that time the shipyard becomes wide well known.
			In the eighties of the 20th century, the Shipyard Punat is the biggest for constructing wooden vessels in Croatia. </p>
		  <p>In time past mainly oriented to wood as a constructive material for shipbuilding, today the shipyard on its facilities, with employees and various subcontractors offers a refit and repair for all kind of working boats and large yachts up to 50 m length. </p>
          <br/><br/><h4>Equipment</h4>
		  <p>   - Travel lift 50t<br/>
				- Travel lift 100t<br/>
				- Transport vehicle for vessels up to 20t
				- Transport vehicle for vessels up to 30t
				- Telescopic work platform for work up to 21m
				- Tug boat
		  </p>
		  <br/><h4>Slipway</h4>
		  <p>   - Slipway 600t for vessels up to 50m
				- Slipway 450 t for catamarans up to 50 m
				- Slipway 150 t for vessels up to 30 m

		  </p>
		  <br/><h4>Covered area</h4>
		  <p>
				- Hale, dimension 60x20x10m with overhead crane 50x11m, capacity 3t
				- Hale, dimension 38x9, 2x8m
				- Shed, dimension 50x22x5m
		  </p><br/>
		  <p>Tend construction on slipways or in the service area for vessel which cannot be transported under a covered area. Power supply distribution on the shipyard working area, with connectors for compressed air, 
