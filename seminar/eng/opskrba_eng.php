  ...
  <body>
		 ...
		 <a class="navbar-brand" href="index.php">Marina Punat</a>
		  <!-- <img src="images/object0.png" alt="Marina Punat" height="153" width="153" style="position:absolute; z-index: 1000;display: block;"> -->
            ...
            <ul class="nav navbar-nav">
              <li><a href="../opskrba.php">HRV</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
		<h4>SUPERMARKET</h4>
          <p>Kvarner Punat Stores d.o.o.
				in the central part of the marina, near the restaurant Marina </p><br/>
		<h4>DISCOUNT</h4>
		  <p>Kvarner Punat Stores d.o.o.
				across the street, next to the dry storage Brodica </p>
		  <p>The grocery shops Supermarket and Diskont stores offer all foods and fresh products, which are necessary for a longer sailing, with a large selection of fine wines and various alcoholic beverages remaining.
			Furthermore, there you will find all important kitchen articles and small household products, various cleaning agents, cosmetics and even foreign newspapers and magazines.
			The offer of the store Diskont, additionally to the long-lasting food and household accessories, includes a large selection of various alcoholic and nonalcoholic beverages at affordable prices.. </p><br/>
		  <p>Summer opening times:<br/><br/>
			Monday to Thursday 7 – 21 h<br/>
			Friday to Saturday 7 – 22 h<br/>
			Sunday: 8-13 h; from 1.7.: 8-21 h </p>
