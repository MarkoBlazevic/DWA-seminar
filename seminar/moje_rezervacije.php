        ...
        <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="index.php">Marina Punat</a>
            ...
            <ul class="nav navbar-nav">
				...
				<li><a href="eng/moje_rezervacije_eng.php">ENG</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10">
			...
			$query = "SELECT * FROM rezervacija WHERE idKlijenta = (SELECT idKlijent FROM klijent INNER JOIN podaci ON klijent.idProba = podaci.id WHERE podaci.korisnickoIme = '$kor_ime');";
			$result = mysqli_query($conn, $query);
			$count=mysqli_num_rows($result);
			?>
			<form name="form1" method="POST" action="moje_rezervacije.php">
				...
				<input name="delete1" type="submit" id="delete1" class="btn btn-default" value="Obriši"></td>
				...
				if(isset($_POST['delete1'])){
				 $checkbox = $_POST['checkbox'];
					...
					if($result){
						echo "<meta http-equiv=\"refresh\" content=\"0;URL=moje_rezervacije.php\">";
					}
				}
				mysqli_close($conn);
				?>
