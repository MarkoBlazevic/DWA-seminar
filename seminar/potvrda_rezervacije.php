      ...
      <div class="container">
		...
		<a class="navbar-brand" href="index.php">Marina Punat</a>
            ...
            <ul class="nav navbar-nav">
				...
				<li><a href="eng/potvrda_rezervacije_eng.php">ENG</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">
			...
			<h4>Odabire dodatne usluge koje želite:</h4><br/>
			<h5>(dnevna cijena iskazana u kn):</h5><br/>

			<form name="potvrda" method="GET" action="potvrda_rezervacije.php">
				<input type="radio" name="usluga" value="8">
				<label for="usluga">Bez usluge </label><br>
				
				<input type="radio" name="usluga" value="1">
				<label for="usluga">Struja (100,00kn)</label><br>
				
				<input type="radio" name="usluga" value="2">
				<label for="usluga">Voda (100,00kn)</label><br>
				
				<input type="radio" name="usluga" value="3">
				<label for="usluga">Internet (60,00kn)</label><br>
				
				<input type="radio" name="usluga" value="4">
				<label for="usluga">Struja + voda (190,00kn)</label><br>
				
				<input type="radio" name="usluga" value="5">
				<label for="usluga">Struja + internet (150,00kn)</label><br>
				
				<input type="radio" name="usluga" value="6">
				<label for="usluga">Voda + internet (150,00kn)</label><br>
				
				<input type="radio" name="usluga" value="7">
				<label for="usluga">Struja + voda + internet (250,00kn)</label><br><br>
			...
			<?php
				...
				if($result1) 
				{
					echo "<script>alert('Uspješno ste rezervirali vez!')</script>";
					echo "<script>window.location = 'index.php';</script>";
				}
				else
				{
