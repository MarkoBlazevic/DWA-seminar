  ...
  <body>
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" role="navigation">
      <div class="container">
        <div class="navbar-header">
		 ...
		 <a class="navbar-brand" href="index.php">Marina Punat</a>
            ...
            <ul class="nav navbar-nav">
				...
				<li><a href="eng/admin_klijenti_eng.php">ENG</a></li>
		...
		/* Stranici može pristupiti samo ulogirani administrator */
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10">
			...
			<h3>Popis aktivnih korisnika</h3>
			...
			?>
			<form name="form1" method="POST" action="admin_klijenti.php">
			...
			<tbody>
				...
				<tr>
					<td align="center" bgcolor="#FFFFFF"><input name="checkbox[]" type="checkbox" id="checkbox[]" value=" <?php echo $rows['idKlijent']; ?> "></td>
					<td> <?php echo $rows['imeKlijent']; ?> </td>
					<td> <?php echo $rows['prezimeKlijent']; ?> </td>
					<td> <?php echo $rows['datumRodjenja']; ?> </td>
					<td> <?php echo $rows['adresa']; ?> </td>
					<td> <?php echo $rows['drzava']; ?> </td>
					<td> <?php echo $rows['predbroj']; ?> </td>
					<td> <?php echo $rows['telefon']; ?> </td>
					<td> <?php echo $rows['dozvola']; ?> </td>
				</tr>
				</tbody>
				...
				?>
					...
					<input name="delete" type="submit" class="btn btn-default" id="delete" value="Obriši">
				...
				if(isset($_POST['delete'])){
				 $checkbox = $_POST['checkbox'];
					for($i=0;$i<count($checkbox);$i++){
						$del_id = $checkbox[$i];
						$sql = "DELETE FROM klijent WHERE idKlijent = '$del_id';";
						$result = mysqli_query($conn, $sql);
					}
					if($result){
						echo "<meta http-equiv=\"refresh\" content=\"0;URL=admin_klijenti.php\">";
					}
				}
				mysqli_close($conn);
				?>	
